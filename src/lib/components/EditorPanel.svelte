<script lang="ts">
	...
	const {
		tabs, currentSlug, editorContent, currentFrontmatter, currentFmFormat,
		wordCount, charCount, saveState, saveRequest, loading,
		currentArchetype, currentConfigSlug, conflictSlug, currentTab,
	} = editorStore;
	...
	// Remount key pour forcer le remount de l'éditeur quand les settings changent
