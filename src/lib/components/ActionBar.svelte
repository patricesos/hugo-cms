<script lang="ts">
	import { PanelLeftClose, PanelLeftOpen, Search, FilePlus, FolderPlus, RefreshCw, Map, Eye, Terminal, GitBranch, Globe, Lock, Loader2, ExternalLink, Settings } from '@lucide/svelte';
