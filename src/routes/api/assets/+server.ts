...
export async function POST({ request }) {
	...
	const imagesDir = safeResolveIn(getCmsConfig().hugoStaticPath, getCmsConfig().imagesDir);
	...
	const filepath = safeResolveIn(getCmsConfig().hugoStaticPath, getCmsConfig().imagesDir, filename);
